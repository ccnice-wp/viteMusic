 ...
 * @Date: 2023-04-01 12:11:53
 * @LastEditors: ccnice whl0808_work@163.com
 * @LastEditTime: 2023-05-15 18:54:03
 * @FilePath: /musicManage/src/layout/content/tab01/tables/tableTwo.vue
 * @Description: null
-->
<script setup>
...
onMounted(() => {
  adminService.getInfo().then(res => {
    numberAni(res.data.data[0][2].totalSongs)
  })
})
...
<template>
  <div class="mt-5 mx-10 border-2 border-red-400 w-1/6 h-20 inline-flex items-center">
    ...
    <el-icon size="40" class="ml-8"><Headset /></el-icon>    


    <div class="ml-20">
      <a href="" class="block">{{ tweened.number.toFixed(0) }}</a>
      <a href="" class="block">歌曲总数</a>
    </div>
